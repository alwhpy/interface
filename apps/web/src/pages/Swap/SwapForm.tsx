...
export function SwapForm({
  ...
  console.log("🚀 ~ trade:", trade?.outputAmount.toSignificant());
  ...
  const formattedAmounts = useMemo(
    () => ({
      [independentField]: typedValue, //typedValue 输入的值
      ...
      <Column flex="10" gap="sm">
        ...
        <ThemedText.BodySecondary lineHeight="22px">
          <Trans>
            ...
            by modifying our product in a way that is misleading and could harm
            users. Please disable the extension and reload&nbsp;the&nbsp;page.
          </Trans>
